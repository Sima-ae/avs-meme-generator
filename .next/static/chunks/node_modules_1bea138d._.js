...
n" ? this.copyWithin(t, n, i) : Uint8Array.prototype.set.call(e, this.subarray(n, i), t), s;
    ...
    Ut("ERR_BUFFER_OUT_OF_BOUNDS", function(r) {
        return r ? "".concat(r, " is outside of buffer bounds") : "Attempt to access memory outside buffer boun\
ds";
    }, RangeError);
...
on" ? i(t, n) : "".concat(i, "?address=").concat(t, ":").concat(n);
        }
        setNoDelay() {
            return this;
        }
...
//# sourceMappingURL=node_modules_1bea138d._.js.map