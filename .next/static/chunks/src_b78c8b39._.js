...
function MemeResultDialog(param) {
    ...
    const generateAndUploadMeme = async ()=>{
        ...
        try {
            ...
            // Create form data
            const formData = new FormData();
            const filename = "alles-voor-schiedam-".concat(quizState.userName.toLowerCase().replace(/\s+/g, '-'), ".png");
            formData.append('file', blob, filename);
            formData.append('title', "Meme van ".concat(quizState.userName));
            formData.append('userId', (session === null || session === void 0 ? void 0 : (_session_user = session.user) === null || _session_user === void 0 ? void 0 : _session_user.id) || '2');
            console.log('Uploading to API...', {
                filename,
                userId: (session === null || session === void 0 ? void 0 : (_session_user1 = session.user) === null || _session_user1 === void 0 ? void 0 : _session_user1.id) || '2'
            });
            // Upload to API
        ...
        "MemeResultDialog.useEffect": ()=>{
            if (isOpen && !autoUploaded) {
                ...
                const timer = setTimeout({
                    "MemeResultDialog.useEffect.timer": ()=>{
                        generateAndUploadMeme();
                    }
                }["MemeResultDialog.useEffect.timer"], 2000);
                return ({
                    "MemeResultDialog.useEffect": ()=>clearTimeout(timer)
                })["MemeResultDialog.useEffect"];
            }
        }
    }["MemeResultDialog.useEffect"], [
    ...
    const handleDownloadPNG = async ()=>{
        ...
        try {
            ...
            const primaryAnswer = selectedAnswers[0];
            const resultText = (primaryAnswer === null || primaryAnswer === void 0 ? void 0 : primaryAnswer.result_text) || 'Kiest voor Schiedam';
            ctx.font = '14px Arial';
    ...
    const handleDownloadJPG = async ()=>{
        ...
        try {
            ...
            const filename = "alles-voor-schiedam-".concat(quizState.userName.toLowerCase().replace(/\s+/g, '-'), ".jpg");
            const link = document.createElement('a');
            link.download = filename;
            link.href = dataUrl;
            link.click();
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        ...
                        children: [
                            (uploaded || autoUploaded) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MemeResultDialog, "dJMUuHOmj+u2cm0900GhM3OcjFM=", false, function() {
    return [
